...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 26, 2021 at 05:00 AM
...
(2, 'dmakwana@gmail.com', 7, 1, 100, 95, 'Rajkot', NULL, NULL, NULL, '88888 99999', 'Cash on delivery(COD)', '', 'processing', '2021-03-25', '2021-03-26 01:54 AM', 'jayesh@gmail.com'),
(3, 'dmakwana@gmail.com', 8, 1, 100, 95, 'Rajkot', NULL, NULL, NULL, '88888 99999', 'Cash on delivery(COD)', '', 'processing', '2021-03-25', '2021-03-26 01:54 AM', 'jayesh@gmail.com'),
(4, 'dmakwana@gmail.com', 34, 3, 55, 159, 'Rajkot', NULL, NULL, NULL, '88888 99999', 'Cash on delivery(COD)', '', 'processing', '2021-03-25', '2021-03-26 01:54 AM', 'jayesh@gmail.com'),
(5, 'dmakwana@gmail.com', 7, 1, 100, 95, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2021-03-26', NULL, NULL),
(6, 'dmakwana@gmail.com', 8, 1, 100, 95, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2021-03-26', NULL, NULL);
...
(2, 'jayesh@gmail.com', '12345', 'Jayesh', 'Rajkot', '9974419338', 'Gangabuvan,Jasdan,360050', 'assigned'),
(4, 'ksakhiya@gmail.com', '12345', 'ksakhiya', 'Jasdan', '8128763389', 'Kailash Nagar, Jasdan,360055', 'available'),
...
INSERT INTO `order_details` (`order_details_id`, `email`, `subject`, `body`, `user_type`) VALUES
(10, 'radhe@gmail.com', 'About shop edit', 'I want to edit some of the information about my shop', 'Shopkeeper'),
(12, 'deep@gmail.com', 'Shipping services', 'Your shipping service is good, I received my orders on time, thank you :)', 'Customer');
...
(4, 'Milk', 'Milk is the very needed and healthy drink for body.', 'milk.jpg', 47, 5, 5, 2, 2, '500 ml'),
...
(37, 'Medimix Ayurvedic Classic 18 Herbs Soap', 'Medimix Classic with its 18 Herb Ayurvedic Formula nourishes and protects your skin.', 'medmix.jpg', 172, 7, 50, 20, 5, '4x125 gms');
...
(1, 'Kalpesh', 'ksarvaiya248@gmail.com', '12345', 'Kalpesh Kariyana Store', '9898672365', 'All types of items of the grocery are available 24 hours'),
...
(7, 'Bhupatbhai', 'bhupatsarvaiya@gmail.com', '123456', 'Madhuram Kariyana', '9974419338', 'We are providing all the products of the grocery');
...
(18, 'Jayesh', 'jayesh@gmail.com', '12345', '9974419338', 'Delivery boy', 'Gangabuvan,Jasdan,360050'),
...
(26, 'Bhupatbhai', 'bhupatsarvaiya@gmail.com', '123456', '9974419338', 'Shopkeeper', 'Tower Road,Vadod'),
...
--
ALTER TABLE `category`
  MODIFY `categoryId` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
...
--
ALTER TABLE `order_details`
  MODIFY `order_details_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
