      ...
      <div class="row features-inner">
        ...
        <div class="col-lg-3 col-md-6 col-sm-6">
          <div class="single-features">
            ...
            <h6>Home Delivery</h6>
            <p>Shipping at reasonable price</p>
          </div>
        </div>
        ...
        <div class="col-lg-3 col-md-6 col-sm-6">
          <div class="single-features">
            ...
            <h6>Return Policy</h6>
            <p>Cacel order according to its status</p>
          </div>
        </div>
        ...
        <div class="row justify-content-center">
          <div class="col-lg-6 text-center">
            <div class="section-title">
              ...
              <p>You can find different masala products here from different shops.</p>
            </div>
          </div>
        </div>
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="single-product">
                <img class="img-fluid" style="max-height:240px; max-width: 100%; width:auto" src="img/product/<%=p.getPphoto()%>" alt="">
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-6 text-center">
            <div class="section-title">
              <h1>Fruits</h1>
              <p>You can find fruits here from different shops.</p>
            </div>
          </div>
        </div>
        <div class="row">
