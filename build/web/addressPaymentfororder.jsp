                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-7">
                            ...
                            <table class="table table-hover" width='100%'>
                                ...
                                <thead>
                                <tr>
                                    <th colspan="2" rowspan="1" style="background-color: #ededed;color: black"><a href="mycart.jsp"><i style="color: black;" class="fa fa-arrow-left"></i> </a>Back</th>
                                    <%if (total > 0 && total < 2000) {
                                            db_charge = 50;%><th colspan="2" style="background-color: #ededed; color: black">Total: <i class="fa fa-inr"></i><%=total + db_charge%></th><%} else if (total > 2000 && total < 5000) {
                                                    db_charge = 100;%><th colspan="2" style="background-color: #ededed; color: black">Total: <i class="fa fa-inr"></i><%=total + db_charge%></th><%} else {
                                            db_charge = 200;%><th colspan="2" style="background-color: #ededed; color: black">Total: <i class="fa fa-inr"></i><%=total + db_charge%></th><%}

                                        %>
                                        <%if (total > 0 && total < 2000) {
                                        %><th colspan="3" style="background-color: #ededed; color: black">Shipping charges: <i class="fa fa-inr"></i><%=db_charge%></th><%} else if (total > 2000 && total < 5000) {
                                    %><th colspan="3" style="background-color: #ededed; color: black">Shipping charges: <i class="fa fa-inr"></i><%=db_charge%></th><%} else {
                                    %><th colspan="3" style="background-color: #ededed; color: black">Shipping charges: <i class="fa fa-inr"></i><%=db_charge%></th><%}
                                        %>
                                ...
                                <tbody>    
                                    <tr>
                                        ...
                                        <td><img src="img/product/<%=rs.getString(4)%>" style="max-height:120px; max-width: 100%; width:auto"  class="card-img-top m-2" alt=".."></td>
