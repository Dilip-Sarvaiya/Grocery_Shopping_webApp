                    ...
                    <a href="all_shops_for_admin.jsp">
                        <div class="card">
                            ...
                            <div class="card-body text-center">
                                ...
                                <div class="container">
                                    <img style="max-width:122px;" class="img-fluid " src="img/dashboard_icons/shop.png" alt="user_icon" />
                                </div> 
                ...
                <div class="col-md-4">
                    <div class="card" data-toggle="modal" data-target="#add-category-model">
                        ...
                        <div class="card-body text-center">
                            ...
                            <div class="container">
                                <img style="max-width:110px;" class="img-fluid " src="img/dashboard_icons/calculator.png" alt="user_icon" />
                            </div> 
                ...
                <div class="col-md-4">
                    <div class="card" data-toggle="modal" data-target="#add-product-model">
                        ...
                        <div class="card-body text-center">
                            ...
                            <div class="container">
                                <img style="max-width:110px;" class="img-fluid " src="img/dashboard_icons/plus.png" alt="user_icon" />
                            </div> 
                ...
                <div class="col-md-4">
                    <div class="card" data-toggle="modal" data-target="#add-d_boy-model">
                        ...
                        <div class="card-body text-center">
                            ...
                            <div class="container">
                                <i style="font-size: 110px;" class="fa fa-address-card"></i>
                            </div> 
                    ...
                    <a href="view_messages.jsp">
                        <div class="card">
                            ...
                            <div class="card-body text-center">
                                ...
                                <div class="container">
                                    <i style="font-size: 150px;" class="fa fa-send"></i>
                                </div> 
                                <p class="mt-2" style="font-size: 15px;color: #777;">Click Here to view messages</p>
                                <h1 class="text-uppercase text-muted">View messgaes</h1>
                            </div>
                        </div>
                    </a>
                </div>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <form action="ProductOperation" id="add_product" method="post" enctype="multipart/form-data">
                                        ...
                                        %>
                                        <div class="form-group form-select" style="padding-bottom: 20px;">
                    ...
                    <a href="received_orders.jsp">
                        <div class="card">
                            ...
                            <div class="card-body text-center">
                                ...
                                <div class="container">
                                    <img style="max-width:110px;" class="img-fluid " src="img/dashboard_icons/people.png" alt="user_icon" />
                                </div> 
                                <p class="mt-2" style="font-size: 15px;padding-top: 35px;color: #777;">Click Here to view received orders</p>
