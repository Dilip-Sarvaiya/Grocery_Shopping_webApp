                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <div class="media">
                                            <div class="d-flex">
                                                <img  src="img/product/<%=rs.getString(4)%>" style="max-height:170px; max-width: 100%; width:auto" alt="">
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                            ...
                            <tr class="out_button_area">
                                ...
                                <td>
                                    <div class="checkout_btn_inner d-flex align-items-center">
                                        ...
                                        <a id="checkout" class="primary-btn" href="addressPaymentfororder.jsp">Proceed to checkout</a>
                                    </div>
                                </td>
                            </tr>
                            </tbody>
